                                ...
                                <TableBody className="text-sm text-gray-800">
                                    ...
                                    {!isLoading && products.map((product) => (
                                        <TableRow key={product.id} className="border-b hover:bg-gray-50">
                                            ...
                                            <TableCell className="px-4 py-3">
                                                {product.trangThai === 1
                                                    ? <span className="px-2 py-1 text-xs rounded bg-green-50 text-green-700">Đang bán</span>
                                                    : <span className="px-2 py-1 text-xs rounded bg-red-50 text-red-700">Ngừng bán</span>}
                                            </TableCell>
